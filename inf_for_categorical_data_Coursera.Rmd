...
<li> A poll conducted by WIN-Gallup International surveyed 51,927 people from 57 countries  THIS ONE. </li>
</ol>
...
<ol>
<li> Countries </li> 
<li> Individual Persons THIS ONE</li> 
<li> Religions </li>
</ol>
...
```{r us-atheism-ci}
CI <- inference(y = response, data = us12, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")$CI
```
...
<li> The margin of error for the estimate of the proportion of atheists in the US in 2012 is 0.0135.THIS ONE </li>
</ol>
...
x <- filter(atheism, nationality == 'China')
summary(x$response)
...
<li> The $ME$ is maximized when $p = 0.5$. THIS ONE </li> 
...
<ol>
<li> True </li> 
<li> False THIS ONE </li>
</ol>
```{r spain-05-12}
# type your code for Question 10 here, and Knit
sp <- filter(atheism, nationality=='Spain')
inference(y = response, x = year, data = sp, statistic = "proportion", success = "atheist", type = "ht", method = "theoretical", alternative = "twosided")
```
...
filter(atheism, nationality=='United States') -> us
inference(y = response, x = as.factor(year), data = us, statistic = "proportion", success = "atheist", type = "ht", method = "theoretical", alternative = "twosided")
```
...
<li> 9604 people </li> 
<li> At least 9604 people THIS ONE </li>
</ol>
```{r sample-size}
