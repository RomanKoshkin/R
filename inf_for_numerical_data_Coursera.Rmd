...
<li> The IQRs of the distributions are roughly equal THIS ONE IS FALSE. </li>
</ol>
```{r habit-weight-box}
...
<li> We are 95% confident that babies born to nonsmoker mothers are on average 0.05 to 0.58 pounds heavier at birth than babies born to smoker mothers THIS ONE. </li>
</ol>
```{r habit-weight-ci}
# type your code for the Question 5 here, and Knit
inference(y = weight, x = habit, data = nc, statistic = "mean", type = "ci", null = 0, alternative = "onesided", method = "theoretical")
```
...
<li>(6.9779 , 7.2241)</li>
<li>(38.0952 , 38.5742) THIS ONE</li>
</ol>
```{r weeks-ci-99}
# type your code for Question 6 here, and Knit
inference(y = weeks, data = nc, statistic = "mean", type = "ci", null = 0, alternative = "less", method = "theoretical", conf_level = 0.99)
```
